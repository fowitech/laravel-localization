...
[![Latest Stable Version](https://poser.pugx.org/fowitech/laravel-localization/version.png)](https://packagist.org/packages/fowitech/laravel-localization) [![Total Downloads](https://poser.pugx.org/fowitech/laravel-localization/d/total.png)](https://packagist.org/packages/fowitech/laravel-localization) [![Build Status](https://travis-ci.org/fowitech/laravel-localization.png)](https://travis-ci.org/fowitech/laravel-localization)
[![Open Source Helpers](https://www.codetriage.com/fowitech/laravel-localization/badges/users.svg)](https://www.codetriage.com/fowitech/laravel-localization)
...
Register the middleware `LocalizationViewPath` to set current locale as view-base-path.
...
It is necessary that at least the `localize` middleware in loaded in your `Route::group` middleware (See [installation instruction](#LocalizationRoutes)).
