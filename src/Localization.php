...
use Fowitech\Localization\Exceptions\SupportedLocalesNotDefined;
use Fowitech\Localization\Exceptions\UnsupportedLocaleException;
...
class Localization
{
    ...
    public function getSupportedLocales()
    {
        ...
        // locales
        $locales = [];
        if($this->configRepository->get('localization.driver') == 'file'){
            $data = $this->configRepository->get('localization.supportedLocales');
            if($data){
